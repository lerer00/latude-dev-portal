...
export class Authority extends StaticWeb3Contract {
    ...
    public async canCall(params: {
        caller: string;
        target: string;
        sig: string
    }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.canCall.call(params.caller, params.target, params.sig)
    }
...
export class Authorization extends StaticWeb3Contract {
    ...
    public async terminate(params: { senderAddress: string }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.terminate({ from: params.senderAddress })
    }
    ...
    public async setOwner(params: {
        newOwner: string;
        senderAddress: string
    }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.setOwner(params.newOwner, { from: params.senderAddress })
    }
    ...
    public async owner(params: {}): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.owner.call()
    }
    ...
    public async authority(params: {}): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.authority.call()
    }
...
export class Migrations extends StaticWeb3Contract {
    ...
    public async upgrade(params: {
        ...
        const instance = await this._getInstance();
        return await instance.upgrade(params.new_address, { from: params.senderAddress })
    }
    ...
    public async last_completed_migration(params: {}): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.last_completed_migration.call()
    }
    ...
    public async setCompleted(params: {
        completed: string;
        senderAddress: string
    }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.setCompleted(params.completed, { from: params.senderAddress })
    }
...
export class Company extends StaticWeb3Contract {
    ...
    public async name(params: {}): Promise<string | null> {
        const instance = await this._getInstance();
    ...
    public async exchangeContract(params: {}): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.exchangeContract.call()
    }
    ...
    public async addProperty(params: {
        _name: string;
        senderAddress: string
    }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.addProperty(params._name, { from: params.senderAddress })
    }
    ...
    public async getProperties(params: {}): Promise<string[] | null> {
        const instance = await this._getInstance();
        return await instance.getProperties.call()
    }
    ...
    public async properties(params: { param0: string }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.properties.call(params.param0)
    }
...
export class ExchangeRates extends StaticWeb3Contract {
    ...
    public async getCurrencyRate(params: { _currency: string }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.getCurrencyRate.call(params._currency)
    }
    ...
    public async isCurrencyAllowed(params: { _currency: string }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.isCurrencyAllowed.call(params._currency)
    }
    ...
    public async setDelay(params: {
        newDelay: string;
        senderAddress: string
    }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.setDelay(params.newDelay, { from: params.senderAddress })
    }
...
export class CompanyFactory extends StaticWeb3Contract {
    ...
    public async addCompany(params: {
        name: string;
        senderAddress: string
    }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.addCompany(params.name, { from: params.senderAddress })
    }
...
export class Property extends StaticWeb3Contract {
    ...
    public async addStay(params: {
        ...
        const instance = await this._getInstance();
        return await instance.addStay(params.assetId, params.startTime, params.endTime, { from: params.senderAddress })
    }
    ...
    public async getStay(params: {
        assetId: string;
        stayId: string
    }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.getStay.call(params.assetId, params.stayId)
    }
    ...
    public async getStays(params: {
        assetId: string;
        from: string;
        to: string
    }): Promise<string[] | null> {
        const instance = await this._getInstance();
        return await instance.getStays.call(params.assetId, params.from, params.to)
    }
    ...
    public async addAsset(params: {
        ...
        const instance = await this._getInstance();
        return await instance.addAsset(params.price, params.currency, { from: params.senderAddress })
    }
    ...
    public async lastMetadataHashForAsset(params: { id: string }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.lastMetadataHashForAsset.call(params.id)
    }
    ...
    public async addMetadataHashForAsset(params: {
        id: string;
        hash: string;
        senderAddress: string
    }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.addMetadataHashForAsset(params.id, params.hash, { from: params.senderAddress })
    }
    ...
    public async stays(params: {
        param0: string;
        param1: string
    }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.stays.call(params.param0, params.param1)
    }
    ...
    public async getNodesBetween(params: {
        assetId: string;
        from: string;
        to: string
    }): Promise<string[] | null> {
        const instance = await this._getInstance();
        return await instance.getNodesBetween.call(params.assetId, params.from, params.to)
    }
    ...
    public async getAsset(params: { id: string }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.getAsset.call(params.id)
    }
    ...
    public async numberOfAssets(params: {}): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.numberOfAssets.call()
    }
    ...
    public async getStayPriceInWei(params: {
        assetId: string;
        stayDurationInDays: string
    }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.getStayPriceInWei.call(params.assetId, params.stayDurationInDays)
    }
...
export class OraclizeAddrResolverI extends StaticWeb3Contract {
    ...
    public async getAddress(params: { senderAddress: string }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.getAddress({ from: params.senderAddress })
    }
...
export class OraclizeI extends StaticWeb3Contract {
    ...
    private $getPriceGuard0(params: any): params is {
        _datasource: string;
        gaslimit: string;
        senderAddress: string
    } {
        return '_datasource' in params && 'gaslimit' in params && 'senderAddress' in params
    }


    private $getPriceGuard1(params: any): params is {
        _datasource: string;
        senderAddress: string
    } {
        return '_datasource' in params && 'senderAddress' in params
    }
    ...
    public async getPrice(params: {
        ...
        if (this.$getPriceGuard0(params)) {
            return await instance.getPrice(params._datasource, params.gaslimit, { from: params.senderAddress })
        }


        if (this.$getPriceGuard1(params)) {
            return await instance.getPrice(params._datasource, { from: params.senderAddress })
        }
    ...
    public async useCoupon(params: {
        _coupon: string;
        senderAddress: string
    }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.useCoupon(params._coupon, { from: params.senderAddress })
    }
    ...
    public async setProofType(params: {
        _proofType: string;
        senderAddress: string
    }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.setProofType(params._proofType, { from: params.senderAddress })
    }
    ...
    public async query2(params: {
        ...
        const instance = await this._getInstance();
        return await instance.query2(params._timestamp, params._datasource, params._arg1, params._arg2, { from: params.senderAddress })
    }
    ...
    public async queryN(params: {
        ...
        const instance = await this._getInstance();
        return await instance.queryN(params._timestamp, params._datasource, params._argN, { from: params.senderAddress })
    }
    ...
    public async query2_withGasLimit(params: {
        _timestamp: string;
        _datasource: string;
        _arg1: string;
        _arg2: string;
        ...
        const instance = await this._getInstance();
        return await instance.query2_withGasLimit(params._timestamp, params._datasource, params._arg1, params._arg2, params._gaslimit, { from: params.senderAddress })
    }
    ...
    public async randomDS_getSessionPubKeyHash(params: { senderAddress: string }): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.randomDS_getSessionPubKeyHash({ from: params.senderAddress })
    }
    ...
    public async query(params: {
        ...
        const instance = await this._getInstance();
        return await instance.query(params._timestamp, params._datasource, params._arg, { from: params.senderAddress })
    }
    ...
    public async cbAddress(params: {}): Promise<string | null> {
        const instance = await this._getInstance();
        return await instance.cbAddress.call()
    }
    ...
    public async query_withGasLimit(params: {
        _timestamp: string;
        _datasource: string;
        _arg: string;
        _gaslimit: string;
        ...
        const instance = await this._getInstance();
        return await instance.query_withGasLimit(params._timestamp, params._datasource, params._arg, params._gaslimit, { from: params.senderAddress })
    }
    ...
    public async queryN_withGasLimit(params: {
        _timestamp: string;
        _datasource: string;
        _argN: string;
        _gaslimit: string;
        ...
        const instance = await this._getInstance();
        return await instance.queryN_withGasLimit(params._timestamp, params._datasource, params._argN, params._gaslimit, { from: params.senderAddress })
    }
    ...
    public async setCustomGasPrice(params: {
        _gasPrice: string;
        senderAddress: string
    }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.setCustomGasPrice(params._gasPrice, { from: params.senderAddress })
    }
    ...
    public async setConfig(params: {
        _config: string;
        senderAddress: string
    }): Promise<void | null> {
        const instance = await this._getInstance();
        return await instance.setConfig(params._config, { from: params.senderAddress })
    }
